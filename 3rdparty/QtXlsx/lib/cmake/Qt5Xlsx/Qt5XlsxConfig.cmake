...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5Xlsx" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Xlsx_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
macro(_populate_Xlsx_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Xlsx_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
    ...
    set_target_properties(Qt5::Xlsx PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt0Xlsx.so.0"
...
if (NOT TARGET Qt5::Xlsx)
    ...
    set(_Qt5Xlsx_OWN_INCLUDE_DIRS "${_qt5Xlsx_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5Xlsx_install_prefix}/include/arm-linux-gnueabihf/qt5/QtXlsx")
    set(Qt5Xlsx_PRIVATE_INCLUDE_DIRS
        "${_qt5Xlsx_install_prefix}/include/arm-linux-gnueabihf/qt5/QtXlsx/0.3.0"
        "${_qt5Xlsx_install_prefix}/include/arm-linux-gnueabihf/qt5/QtXlsx/0.3.0/QtXlsx"
    )
    ...
    _populate_Xlsx_target_properties(RELEASE "libQt0Xlsx.so.0.3.0" "" )
    ...
    macro(_populate_Xlsx_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Xlsx_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Xlsx_check_file_exists(${imported_location})
